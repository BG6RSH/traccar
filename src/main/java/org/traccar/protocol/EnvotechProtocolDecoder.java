...
public class EnvotechProtocolDecoder extends BaseProtocolDecoder {
    ...
    protected Object decode(
        ...
        position.setLatitude_wgs84(parser.nextCoordinate(Parser.CoordinateFormat.DEG_DEG_HEM));
        position.setLongitude_wgs84(parser.nextCoordinate(Parser.CoordinateFormat.DEG_DEG_HEM));
