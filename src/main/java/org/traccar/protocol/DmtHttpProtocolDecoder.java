...
public class DmtHttpProtocolDecoder extends BaseHttpProtocolDecoder {
            ...
            for (int j = 0; j < fields.size(); j++) {
                ...
                switch (field.getInt("FType")) {
                    case 0:
                        ...
                        position.setLatitudeWgs84(field.getJsonNumber("Lat").doubleValue());
                        position.setLongitudeWgs84(field.getJsonNumber("Long").doubleValue());
    ...
    private Position decodeEdge(
        ...
        if (root.containsKey("lat") && root.containsKey("lng")) {
            ...
            position.setLongitudeWgs84(root.getJsonNumber("lng").doubleValue());
