...
public class TelemaxProtocolDecoder extends BaseProtocolDecoder {
    ...
    protected Object decode(
        ...
        for (int i = 0; i < count; i++) {
            ...
            position.setLongitudeWgs84((Integer.parseInt(readValue(sentence, index, 6), 16) - 5400000) / 30000.0);
            position.setLatitudeWgs84((Integer.parseInt(readValue(sentence, index, 6), 16) - 5400000) / 30000.0);
