...
public class Gps103ProtocolDecoder extends BaseProtocolDecoder {
    ...
    private Position decodeRegular(Channel channel, SocketAddress remoteAddress, String sentence) {
        ...
        if (parser.hasNextAny(20)) {
            ...
            position.setLatitudeWgs84(parser.nextCoordinate(Parser.CoordinateFormat.HEM_DEG_MIN_HEM));
            position.setLongitudeWgs84(parser.nextCoordinate(Parser.CoordinateFormat.HEM_DEG_MIN_HEM));
