...
public class TelicProtocolDecoder extends BaseProtocolDecoder {
    ...
    protected Object decode(
        ...
        if (parser.hasNext(2)) {
            position.setLongitude_wgs84(parser.nextDouble() / 1000000);
            position.setLatitude_wgs84(parser.nextDouble() / 1000000);
        }

        if (parser.hasNext(2)) {
            position.setLongitude_wgs84(parser.nextDouble() / 10000);
            position.setLatitude_wgs84(parser.nextDouble() / 10000);
        }
