...
public class AutoFonProtocolDecoder extends BaseProtocolDecoder {
    ...
    protected Object decode(
        ...
        if (type == MSG_LOCATION) {
            ...
            position.setLatitude_wgs84(convertCoordinate(buf.readUnsignedByte(), buf.readUnsignedMedium()));
            position.setLongitude_wgs84(convertCoordinate(buf.readUnsignedByte(), buf.readUnsignedMedium()));
            position.setSpeed(buf.readUnsignedByte());
