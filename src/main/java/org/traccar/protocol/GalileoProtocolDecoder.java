...
public class GalileoProtocolDecoder extends BaseProtocolDecoder {
    ...
    private void decodeMinimalDataSet(Position position, ByteBuf buf) {
        ...
        position.setLongitude_wgs84(360 * bits.readUnsigned(22) / 4194304.0 - 180);
        position.setLatitude_wgs84(180 * bits.readUnsigned(21) / 2097152.0 - 90);
    ...
    private Position decodeIridiumPosition(Channel channel, SocketAddress remoteAddress, ByteBuf buf) {
        ...
        position.setLongitude_wgs84(BitUtil.check(flags, 0) ? -longitude : longitude);
        ...
        if (getCompressed(deviceSession.getDeviceId())) {
            ...
            while (data.isReadable()) {
                ...
                if (tag == 0x30) {
                    ...
                    position.setLatitude_wgs84(data.readIntLE() / 1000000.0);
                    position.setLongitude_wgs84(data.readIntLE() / 1000000.0);
                } else {
                    decodeTag(position, data, tag);
                }
            }
