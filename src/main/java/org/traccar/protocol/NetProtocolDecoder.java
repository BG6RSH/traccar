...
public class NetProtocolDecoder extends BaseProtocolDecoder {
    ...
    protected Object decode(
        ...
        position.setLatitude_wgs84(parser.nextCoordinate(Parser.CoordinateFormat.DEG_MIN_MIN) * hemisphereLatitude);
        position.setLongitude_wgs84(parser.nextCoordinate(Parser.CoordinateFormat.DEG_MIN_MIN) * hemisphereLongitude);
