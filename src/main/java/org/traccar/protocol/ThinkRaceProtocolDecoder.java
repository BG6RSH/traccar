...
public class ThinkRaceProtocolDecoder extends BaseProtocolDecoder {
    ...
    protected Object decode(
        ...
        if (type == MSG_LOGIN) {
            ...
            position.setLatitudeWgs84(convertCoordinate(buf.readUnsignedInt(), !BitUtil.check(flags, 0)));
            position.setLongitudeWgs84(convertCoordinate(buf.readUnsignedInt(), !BitUtil.check(flags, 1)));
