        ...
        if (type == MSG_RECORDS || type == MSG_EXTENDED_RECORDS) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (longitude > Integer.MIN_VALUE && latitude > Integer.MIN_VALUE) {
                    ...
                    position.setLongitudeWgs84(longitude / 10000000.0);
                    position.setLatitudeWgs84(latitude / 10000000.0);
            ...
            for (int i = 0; i < count; i++) {
                ...
                position.setValid(true);
                position.setLongitudeWgs84(buf.readInt() / 10000000.0);
                position.setLatitudeWgs84(buf.readInt() / 10000000.0);
